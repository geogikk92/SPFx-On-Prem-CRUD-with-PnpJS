...
import styles from './SpFxOnPrenPnPjsWebPart.module.scss';
import * as strings from 'spFxOnPrenPnPjsStrings';
import { ISpFxOnPrenPnPjsWebPartProps } from './ISpFxOnPrenPnPjsWebPartProps';
import { IListItem } from './IListItem';

import * as pnp from 'sp-pnp-js';
import { Item, ItemAddResult, ItemUpdateResult } from '../../../node_modules/sp-pnp-js/lib/sharepoint/items';

export default class SpPnPJsCrudWebPart extends BaseClientSideWebPart<ISpFxOnPrenPnPjsWebPartProps> {
